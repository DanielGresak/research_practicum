import requests
from core.weather.models import Forecast
...
def update_weather_forecast():
    ...
    if forecast_json is not None:
        try:
            ...
            new_forecast_entity.pop = forecast_json['list'][0]['wind']['pop']

            # Insert new forecast into database
            new_forecast_entity.save()
        except:
            # Todo: Error logging
            print("Inserting new weather forecast entity into database failed!")
